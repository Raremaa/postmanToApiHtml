 ...
 * from: https://www.cnblogs.com/xsnd/p/8708817.html
 * 只可用于Postman导出V1版本
 */
...
//        readFile("C:\\Users\\Yan\\Desktop\\api\\h.json");
        readFile("C:\\Users\\masaiqi\\Desktop\\加码教务管理系统.postman_collection.json");
    }
    ...
    private static void writeToHtml(String title, List<PostMan> postManList) {
        ...
        FileUtil.createFile("API_Html",buffer.toString());
    }
